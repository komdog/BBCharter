...
# Keyframe Prefabs
const shutter_keyframe = preload("res://prefabs/ShutterKeyframe.tscn")
const animation_keyframe = preload("res://prefabs/AnimationKeyframe.tscn")
const effect_keyframe = preload("res://prefabs/EffectKeyframe.tscn")
const background_keyframe = preload("res://prefabs/BackgroundKeyframe.tscn")
